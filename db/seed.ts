...
await db
	...
	.values([
		...
		{
			id: "iwgp-global-heavyweight",
			organizationId: "njpw",
			name: "IWGP GLOBALヘビー級王座",
			displayOrder: 2,
		},
		{
			id: "iwgp-jr",
		...
		{
			id: "strong-openweight-tag-team",
			organizationId: "njpw",
			name: "STRONG無差別級タッグ王座",
			displayOrder: 9,
		},
		{
			id: "never-6tag",
			organizationId: "njpw",
			name: "NEVER無差別級6人タッグ王座",
			displayOrder: 10,
		},
		{
			id: "iwgp-world-heavyweight",
			organizationId: "njpw",
			name: "IWGP世界ヘビー級王座",
			displayOrder: 11,
		},
		{
			id: "inter-continental",
			organizationId: "njpw",
			name: "IWGPインターコンチネンタル王座",
			displayOrder: 12,
		},
		{
			id: "iwgpus",
